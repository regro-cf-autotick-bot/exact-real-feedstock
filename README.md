...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/exact-real-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/exact-real-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libexactreal pyexactreal
# for installing globally
pixi global install libexactreal pyexactreal
```
...
It is possible to list all of the versions of `libexactreal` available on your platform:
...
```
pixi search libexactreal --channel conda-forge
```
